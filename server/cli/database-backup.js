...
async function main() {
  ...
  process.stdout.write(JSON.stringify({...result,notice:'Database only. Preserve playbooks, plugins, infrastructure state/files and the original FLEET_KEY_SECRET separately.'})+'\n');
}
