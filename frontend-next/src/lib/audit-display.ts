...
export function auditActionLabel(action?: string): string {
  ...
  const labels: Record<string,string> = {
    ...
    'maintenance_window.create':'Maintenance scheduled',
    'maintenance_window.update':'Maintenance changed',
    'maintenance_window.cancel':'Maintenance cancelled',
    'maintenance_window.delete':'Maintenance removed',
