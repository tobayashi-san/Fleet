...
const root=fs.mkdtempSync(path.join(os.tmpdir(),'fleet-mfa-browser-'));
process.env.DB_PATH=path.join(root,'test.db');process.env.NODE_ENV='test';process.env.JWT_SECRET='synthetic-browser-only';process.env.FLEET_MFA_POLICY='all';
