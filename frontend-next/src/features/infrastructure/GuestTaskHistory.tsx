...
function History({apiRoot,environmentId}:Props){
 ...
 return <Card><CardHeader><CardTitle>Guest requests</CardTitle><p className="text-sm text-muted-foreground">Snapshot and power requests recorded by Shipyard remain available after closing their dialogs. Status shows the last check; use Check status to read the current Proxmox result.</p></CardHeader><CardContent className="space-y-3">
